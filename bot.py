...
def detect_intent(msg: str, phone: str) -> str:
    ...
    if any(w in msg for w in ['help', 'human', 'manager']):
...
def get_ai_response(msg: str) -> str:
    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": f"You are a helpful assistant for {RESTAURANT_NAME}..."
                    },
        ...
        return (f"👋 Hello! Welcome to {RESTAURANT_NAME}!\n\n"
                f"• Type 'MENU' to see our dishes\n"
                f"• Type numbers like '1, 3, 5' to order\n"
                f"• Type 'HOURS' for opening times\n"
                f"• Type 'ADDRESS' for location\n\n"
